...
-- ----------------------------
-- Table structure for black_market_template
-- ----------------------------
DROP TABLE IF EXISTS `black_market_template`;
CREATE TABLE `black_market_template` (
  `Id` int(255) NOT NULL,
  `MarketId` int(255) NOT NULL,
  `SellerNPCEntry` int(255) NOT NULL,
  `ItemEntry` int(255) NOT NULL,
  `Quantity` int(255) NOT NULL,
  `MinBid` int(255) NOT NULL,
...
CREATE TABLE `broadcast_text` (
  ...
  `EndEmoteID` mediumint(8) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `creature` (
  ...
  KEY `idx_map` (`map`),
  KEY `idx_id` (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=328354 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Creature System';
...
CREATE TABLE `creature_template` (
  ...
  `HealthModifier` float(100,0) NOT NULL,
  ...
  `ManaModifier` float(100,0) NOT NULL,
  `ManaModifierExtra` float(100,0) NOT NULL,
  `ArmorModifier` float(100,0) NOT NULL,
...
CREATE TABLE `creature_text` (
  ...
  `BroadcastTextID` mediumint(8) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `gameobject` (
  ...
  `isActive` tinyint(1) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`guid`)
) ENGINE=MyISAM AUTO_INCREMENT=211259 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='Gameobject System';
...
CREATE TABLE `gameobject_loot_currency` (
  `gameobject_id` int(11) DEFAULT NULL,
  `CurrencyId1` int(11) DEFAULT NULL,
  `CurrencyId2` int(11) DEFAULT NULL,
  `CurrencyId3` int(11) DEFAULT NULL,
  `CurrencyCount1` int(11) DEFAULT NULL,
  `CurrencyCount2` int(11) DEFAULT NULL,
  `CurrencyCount3` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `game_tele` (
  ...
  `name` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=10083 DEFAULT CHARSET=utf8 COMMENT='Tele Command';
...
CREATE TABLE `gossip_menu_option` (
  ...
  `box_text` text,
  `OptionBroadcastTextID` int(10) DEFAULT NULL,
  `BoxBroadcastTextID` int(10) DEFAULT NULL,
...
CREATE TABLE `keychain_db2` (
  ...
  `k15` int(11) DEFAULT NULL,
  `k16` int(11) DEFAULT NULL,
  `k17` int(11) DEFAULT NULL,
  `k18` int(11) DEFAULT NULL,
  `k19` int(11) DEFAULT NULL,
  `k20` int(11) DEFAULT NULL,
  `k21` int(11) DEFAULT NULL,
  `k22` int(11) DEFAULT NULL,
  `k23` int(11) DEFAULT NULL,
  `k24` int(11) DEFAULT NULL,
  `k25` int(11) DEFAULT NULL,
  `k26` int(11) DEFAULT NULL,
  `k27` int(11) DEFAULT NULL,
  `k28` int(11) DEFAULT NULL,
  `k29` int(11) DEFAULT NULL,
  `k30` int(11) DEFAULT NULL,
  `k31` int(11) DEFAULT NULL,
  `k32` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- ----------------------------
-- Table structure for lfgdungeon
-- ----------------------------
DROP TABLE IF EXISTS `lfgdungeon`;
CREATE TABLE `lfgdungeon` (
  `ID` int(4) NOT NULL DEFAULT '0',
  `field1` varchar(40) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `field12` varchar(34) COLLATE utf8_unicode_ci DEFAULT NULL,
  `field13` int(4) DEFAULT '0',
  `field14` int(4) DEFAULT '0',
  `field15` int(4) DEFAULT '0',
  `field16` varchar(130) COLLATE utf8_unicode_ci DEFAULT NULL,
...
-- ----------------------------
-- Table structure for lfg_required_ilevel
-- ----------------------------
DROP TABLE IF EXISTS `lfg_required_ilevel`;
CREATE TABLE `lfg_required_ilevel` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=555 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `locales_broadcast_text` (
  ...
  `MaleText_loc1` varchar(500) DEFAULT NULL,
  `MaleText_loc2` varchar(500) DEFAULT NULL,
  `MaleText_loc3` varchar(500) DEFAULT NULL,
  `MaleText_loc4` varchar(500) DEFAULT NULL,
  `MaleText_loc5` varchar(500) DEFAULT NULL,
  `MaleText_loc6` varchar(500) DEFAULT NULL,
  `MaleText_loc7` varchar(500) DEFAULT NULL,
  `MaleText_loc8` varchar(500) DEFAULT NULL,
  `MaleText_loc9` varchar(500) DEFAULT NULL,
  `MaleText_loc10` varchar(500) DEFAULT NULL,
  `MaleText_loc11` varchar(500) DEFAULT NULL,
  `MaleText_loc12` varchar(500) DEFAULT NULL,
  `MaleText_loc13` varchar(500) DEFAULT NULL,
  `MaleText_loc14` varchar(500) DEFAULT NULL,
  `FemaleText_loc1` varchar(500) DEFAULT NULL,
  `FemaleText_loc2` varchar(500) DEFAULT NULL,
  `FemaleText_loc3` varchar(500) DEFAULT NULL,
  `FemaleText_loc4` varchar(500) DEFAULT NULL,
  `FemaleText_loc5` varchar(500) DEFAULT NULL,
  `FemaleText_loc6` varchar(500) DEFAULT NULL,
  `FemaleText_loc7` varchar(500) DEFAULT NULL,
  `FemaleText_loc8` varchar(500) DEFAULT NULL,
  `FemaleText_loc9` varchar(500) DEFAULT NULL,
  `FemaleText_loc10` varchar(500) DEFAULT NULL,
  `FemaleText_loc11` varchar(500) DEFAULT NULL,
  `FemaleText_loc12` varchar(500) DEFAULT NULL,
  `FemaleText_loc13` varchar(500) DEFAULT NULL,
  `FemaleText_loc14` varchar(500) DEFAULT NULL,
  `BroadcastTextID0` int(11) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE `npc_text` (
  ...
  `BroadcastTextID0` int(5) DEFAULT NULL,
  `BroadcastTextID1` int(5) DEFAULT NULL,
  `BroadcastTextID2` int(5) DEFAULT NULL,
  `BroadcastTextID3` int(5) DEFAULT NULL,
  `BroadcastTextID4` int(5) DEFAULT NULL,
  `BroadcastTextID5` int(5) DEFAULT NULL,
  `BroadcastTextID6` int(5) DEFAULT NULL,
  `BroadcastTextID7` int(5) DEFAULT NULL,
  `BroadcastTextID8` int(5) DEFAULT NULL,
  `BroadcastTextID9` int(5) DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `quest_template` (
  ...
  `RewardMoney` int(6) DEFAULT NULL,
  PRIMARY KEY (`Id`)
...
) ENGINE=MyISAM AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COMMENT='Transports';
