...
CREATE TABLE `black_market` (
  ...
  `CurrentBidder` int(10) NOT NULL,
  `CurrentBid` int(10) NOT NULL,
  `MinIncrement` int(10) NOT NULL,
  `NumBids` int(10) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE `character_pet` (
  ...
  `abdata` text,
  `SpecGroups` char(255) NOT NULL,
  `ActiveSpecGroup` char(255) NOT NULL,
  `SpecCount` char(255) NOT NULL,
  PRIMARY KEY (`id`),
